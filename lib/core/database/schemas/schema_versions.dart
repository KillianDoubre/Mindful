...
final class Schema10 extends i0.VersionedSchema {
  ...
  late final Shape18 parentalControlsTable = Shape18(
      ...
      alias: null);
  late final Shape27 restrictionGroupsTable = Shape27(
      source: i0.VersionedTable(
        entityName: 'restriction_groups_table',
        withoutRowId: false,
        isStrict: false,
...
class Shape27 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<int> get periodDurationInMins =>
      columnsByName['period_duration_in_mins']! as i1.GeneratedColumn<int>;
  i1.GeneratedColumn<String> get activePeriods =>
      columnsByName['active_periods']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get distractingApps =>
      columnsByName['distracting_apps']! as i1.GeneratedColumn<String>;
}

i1.GeneratedColumn<String> _column_93(String aliasedName) =>
    i1.GeneratedColumn<String>('active_periods', aliasedName, false,
        type: i1.DriftSqlType.string, defaultValue: Constant(jsonEncode([])));
...
final class Schema11 extends i0.VersionedSchema {
  ...
  late final Shape27 restrictionGroupsTable = Shape27(
      ...
      alias: null);
  late final Shape28 wellbeingTable = Shape28(
      source: i0.VersionedTable(
        entityName: 'wellbeing_table',
        withoutRowId: false,
        isStrict: false,
...
class Shape28 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get nsfwWebsites =>
      columnsByName['nsfw_websites']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get datingBlocks =>
      columnsByName['dating_blocks']! as i1.GeneratedColumn<String>;
}

i1.GeneratedColumn<String> _column_94(String aliasedName) =>
    i1.GeneratedColumn<String>('dating_blocks', aliasedName, false,
        type: i1.DriftSqlType.string, defaultValue: Constant(jsonEncode([])));
...
final class Schema12 extends i0.VersionedSchema {
  ...
  late final Shape27 restrictionGroupsTable = Shape27(
      ...
      alias: null);
  late final Shape29 wellbeingTable = Shape29(
      source: i0.VersionedTable(
        entityName: 'wellbeing_table',
        withoutRowId: false,
        isStrict: false,
...
class Shape29 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get datingBlocks =>
      columnsByName['dating_blocks']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<int> get datingResetTime =>
      columnsByName['dating_reset_time']! as i1.GeneratedColumn<int>;
}

i1.GeneratedColumn<int> _column_95(String aliasedName) =>
    i1.GeneratedColumn<int>('dating_reset_time', aliasedName, false,
        type: i1.DriftSqlType.int, defaultValue: const Constant(0));
...
final class Schema13 extends i0.VersionedSchema {
  ...
  late final Shape18 parentalControlsTable = Shape18(
      ...
      alias: null);
  late final Shape30 restrictionGroupsTable = Shape30(
      source: i0.VersionedTable(
        entityName: 'restriction_groups_table',
        withoutRowId: false,
        isStrict: false,
...
class Shape30 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get activePeriods =>
      columnsByName['active_periods']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<bool> get isIntentPromptEnabled =>
      columnsByName['is_intent_prompt_enabled']! as i1.GeneratedColumn<bool>;
  i1.GeneratedColumn<String> get distractingApps =>
      columnsByName['distracting_apps']! as i1.GeneratedColumn<String>;
}

i1.GeneratedColumn<bool> _column_96(String aliasedName) =>
    i1.GeneratedColumn<bool>('is_intent_prompt_enabled', aliasedName, false,
        type: i1.DriftSqlType.bool,
        defaultConstraints: i1.GeneratedColumn.constraintIsAlways(
